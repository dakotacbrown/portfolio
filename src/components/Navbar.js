    ...
    <>
      <nav className='navbar nav-nav sticky-top navbar-expand-lg navbar-light'>
        <div className="container-fluid">
                  <a className="navbar-brand nav-large pl-lg-5" href={"/"}>
        ...
        <ul className={click ? 'nav-menu active' : 'navbar-nav nav-menu'}>
          ...
          <li className="nav-item dropdown pr-3">
            ...
            <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <NavLink activeClassName="active" className="dropdown-item" to={"/fun/volunteering"} onClick={closeMobileMenu}>Volunteering</NavLink>
                <NavLink activeClassName="active" className="dropdown-item" to={"/fun/music"} onClick={closeMobileMenu}>Music</NavLink>
            </div>
          </li>
