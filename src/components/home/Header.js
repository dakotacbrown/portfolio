                ...
                <div className="container pt-5">
                    <div className="row flex-lg-row-reverse flex-md-row-reverse flex-sm-row">
                        <div className="col-lg-6 order-1">
                            <p className="hero-header text-break">Hello, I'm Dakota-Cheyenne Brown. I'm passionate about <Link className="hero-header-link" to={"/portfolio/work"}>data</Link>, <Link className="hero-header-link" to={"/portfolio/fun/volunteering"}>volunteering</Link>, and <Link className="hero-header-link" to={"/portfolio/fun/music"}>music</Link>.</p>
